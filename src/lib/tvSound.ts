...
export let normalVolume = 0.03;   // 1. Sons normais (movimento, teclas do teclado, limpar, sair, etc.)
export let clickVolume  = 1.5;   // 2. Som de clique / OK / Enter (seleção de elementos)
