...
export let normalVolume = 0.2;   // 1. Sons normais (movimento, teclas do teclado, limpar, sair, etc.)
export let clickVolume  = 3.5;   // 2. Som de clique / OK / Enter (seleção de elementos)
